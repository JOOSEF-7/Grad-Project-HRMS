...
const Splash = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col md:flex-row bg-[#0b141a] text-white overflow-hidden">
      ...
      {/* الجزء الخاص بالتقديم على وظيفة (شمال) */}
      <div 
      ...
      >
        <div className="z-10 text-center">
          ...
          <p className="text-gray-400 text-sm opacity-0 group-hover:opacity-100 transition-opacity">اكتشف الفرص المتاحة وانضم لفريقنا</p>
        </div>
      </div>

      {/* الجزء الخاص بتسجيل الدخول HR (يمين) */}
      <div 
      ...
      >
        <div className="z-10 text-center">
          ...
          <p className="text-gray-400 text-sm opacity-0 group-hover:opacity-100 transition-opacity">إدارة النظام والموظفين</p>
        </div>
      </div>

      {/* لوجو الشركة في النص فوق */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 flex items-center gap-2">
        <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center font-bold italic">S</div>
