...
router.route("/all").get(verifyToken, allowedTo("HR", "MANAGER"), getAllEmployeesPerformance);
router.route("/search").get(verifyToken, allowedTo("HR", "MANAGER"), searchEmployeePerformance);
router.route("/:id").get(verifyToken, allowedTo("HR", "MANAGER"), getEmployeePerformanceHistory);
