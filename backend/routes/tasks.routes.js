...
router.route("/stats").get(verifyToken, allowedTo("EMPLOYEE", "HR", "MANAGER"), getTaskStatistics);
router.route("/task-stats").get(verifyToken, allowedTo("EMPLOYEE", "HR", "MANAGER"), getEmployeeTaskStatistics);

router.route("/search").get(verifyToken, allowedTo("HR", "EMPLOYEE", "MANAGER"), searchTasks);
