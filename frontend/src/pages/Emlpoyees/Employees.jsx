...
import { fetchMonthlyAttendance } from "../../store/slices/attendance/attendanceSlice";
import {fetchAttendance} from "../../store/slices/attendance/attendanceSlice";
...
const selectedDate = useSelector(
  (state) => state.attendance.selectedDate
);
useEffect(() => {
  if (selectedDate) {
